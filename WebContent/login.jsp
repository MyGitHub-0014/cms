...
<div class="login-form">
	...
	<div class="avtar">
		<img src="images/avtar.png" />
			...
			<form action="/java1910/userController" method="post" onsubmit="return check()">
			<input type="hidden" name="flag" value="doLogin">
			<input type="text" class="text"
				value="${cookie.username.value }"
				name="username" id="username" onfocus="this.value = '';"
				>
			<div class="key">
					<input type="password" value="${cookie.password.value }" name="password" id="password" onfocus="this.value = '';" >
				</div>
